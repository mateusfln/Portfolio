            ...
            <div class="flex justify-between items-center px-5">
                ...
                <div class="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
                    ...
                    <div class="relative flex justify-between h-16 items-center ">
                        ...
                        <div class="flex flex-1 justify-center sm:items-stretch sm:justify-center">
                            ...
                            <div class="hidden sm:ml-6 sm:block">
                                <div class="flex space-x-4">
                                    ...
                                    <a href="#howtoreachme" class="text-gray-300 hover:bg-[#4d3d3d] hover:text-white rounded-md px-3 py-2 text-sm font-medium scale-100 hover:scale-105 ease-in duration-150">Contato</a>
                                </div>
                            </div>
                        </div>
