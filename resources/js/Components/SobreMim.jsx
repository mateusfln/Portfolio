...
const SobreMim = () => {
  ...
  const descricoes = [
    {title:'Quem Sou Eu',content:'Olá! Meu chamo Mateus, sou desenvolvedor Full-stack PHP com experiência sólida em desenvolvimento e manutenção de ambientes usando Laravel e React.js.'},
  ...
  const texto = descricoes.map((descricao)=>{
    return(
      <div className="w-full md:w-1/3 p-8 bg-[#F4EFE9] shadow-lg rounded-md m-4 min-h-48 scale-100 hover:scale-105 ease-in duration-150">
